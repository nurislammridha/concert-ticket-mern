          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
            ...
            >
              <img
                ...
                alt="Event JEMES Live Concert"
                className="p-10 w-50 h-50 transform translate-y-[-12%]"
                title="Event JEMES Live Concert"
              />
            ...
            >
              ...
              <p className="text-primary font-medium text-center translate-y-[-100%] sm:translate-y-[-0%] sm:mb-2 md:text-left">
                JEMES event will take place at the  Stadium on June 18 2024.
                JEMES invited a number of collaborators & special guests to participate & be part of this concert.
              </p>
              <br />
