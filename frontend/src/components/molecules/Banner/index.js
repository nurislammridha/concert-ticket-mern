...
const Banner = () => {
  return (
    <div className="parent min-h-[100vh] flex flex-col-reverse lg:flex-row items-center justify-between">
      ...
      >
        <h1 className="text-4xl font-semibold text-center mb-0 translate-y-[100%] sm:translate-y-[-0%] text-primary md:text-left">My Ticket</h1>
        ...
        <p className="text-primary text-center max-w-xl mb-6 font-medium translate-y-[60%] sm:translate-y-[-0%] md:text-left">
          Finally here! The first Bangladeshi men's single stadium concert.
          June Concert and Entertainment are delighted to be holding
          JEMES Live at the Abu Naser Stadium next February.
        </p>
